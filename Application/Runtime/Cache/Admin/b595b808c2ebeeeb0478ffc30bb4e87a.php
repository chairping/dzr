...
<html lang="en">
	<head>
		...
		<!-- <![endif]-->
		<!--[if IE]>
         <script type="text/javascript">window.jQuery || document.write("<script src='/Public/assets/js/jquery-1.10.2.min.js'>"+"<"+"script>");</script>
        <![endif]-->
			...
			<div class="navbar-container" id="navbar-container">
				<div class="navbar-header pull-left">
					<a href="#" class="navbar-brand">
						<small>					
						<img src="/Public/images/logo.png" width="470px">
						</small>
					</a><!-- /.brand -->
				</div><!-- /.navbar-header -->
						...
						<ul class="nav nav-list" id="nav_list">
							...
							<li>
								...
								<ul class="submenu">
										...
										<li class="home"><a  href="javascript:void(0)" name="<?= $subMenu['url']; ?>"  title="<?= $subMenu['name']; ?>" class="iframeurl"><i class="icon-double-angle-right"></i><?= $subMenu['name']; ?></a></li>
										<?php endforeach; ?>
								</ul>
							</li>
							<?php endforeach; ?>
