            ...
            <table class="table table-striped table-bordered table-hover" id="sample-table">
                ...
                <tr>
                    ...
                    <td class="td-manage">
                        ...
                        <a title="编辑"  href="javascript:;"  class="btn goods-edit btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>
    ...
    <div class="">
        <ul>
            <li>
                ...
                <div class="col-sm-9">
                    <input name="分类名称" type="text" id="form-field-1" placeholder="" class="col-xs-10 col-sm-5">
                </div>
            </li>
            ...
            <li>
                ...
                <textarea name="分类说明" class="form-control" id="form-field-8" placeholder="" onkeyup="checkLength(this);">
                </textarea>
            ...
            <li>
                ...
                <span class="add_content"> &nbsp;&nbsp;<label>
                    ...
                    <label><input name="form-field-radio1" type="radio" class="ace"><span class="lbl">隐藏</span></label>
                </span>
            </li>
        </ul>
    </div>
...
//    onclick="member_edit('编辑','<?php echo U("");?>','4','','510')"
    $('.goods-edit').on('click', function() {
        var id = $(this).data('id');
         member_edit('编辑', '<?php echo U("AdminGoods/edit", array("id"=> '+ id+'));?>');
    });
