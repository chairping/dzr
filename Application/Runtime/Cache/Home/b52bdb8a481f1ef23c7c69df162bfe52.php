	...
	<div class="contaniner fixed-cont">
		<section class="to-buy">
			<header>
				...
				<div class="to-now" style="margin-top: 18%;">
					<div class="tonow">
					...
					<h3><a href="/index.php/Address/edit"><img src="/Public/Home/images/write.png"/></a></h3>
				</div>
			</header>
			<div class="buy-list">
				<ul>
					<a href="detail.html">
						<figure>
							<img src="/Public/Home/images/detail-pp01.png"/>
						</figure>
						<li>
